...
-- 2023-08-12,RSokha,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_RSokha')
	 Begin 
	  Alter Database [Assignment06DB_RSokha] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_RSokha;
	 End
	Create Database Assignment06DB_RSokha;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_RSokha;
...
WHERE I.ProductID IN (SELECT ProductID 
						FROM Products WHERE ProductName IN ('Chai','Chang'))
ORDER BY 3,1,2,4;
GO
